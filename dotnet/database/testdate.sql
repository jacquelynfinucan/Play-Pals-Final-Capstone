...
INSERT INTO play_dates (title, host_user_id, host_pet_id, guest_pet_id, date_time, address)
VALUES ('City Park Play Date', 1, 1, 2, GETDATE(),'address1'),									--play_date_id = 1
	('At Home Play Date', 2, 2, 5, GETDATE(),'address2'),										--play_date_id = 2
	('Jogging and Dogs', 3, 3, 2, GETDATE(),'address3'),										--play_date_id = 3
	('Meet and Greet', 4, 4, 1, GETDATE(),'address4'),											--play_date_id = 4
	('Dog Yoga', 5, 5, 7, GETDATE(),'address5'),												--play_date_id = 5
	('Cinder Birthday Get Together', 6, 6, 4, GETDATE(),'address6'),							--play_date_id = 6
	('New Puppies', 7, 7, 6, GETDATE(),'address7'),											--play_date_id = 7
	('Lake Visit', 8, 8, 3, GETDATE(),'address8'),												--play_date_id = 8
	('No Message Test', 1, 1, 3, GETDATE(),'address9');										--play_date_id = 9
